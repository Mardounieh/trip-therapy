...
const TravelMode = () => {
  return (
    <article className="relative w-full h-full flex flex-col gap-5 items-center pt-16 mb-5">
      <div className="absolute top-16 left-0 w-1/2 h-1/2 bg-clrGreen/20 blur-3xl animate-pulse" />
      <div className="absolute bottom-16 right-0 w-1/2 h-1/2 bg-clrBlue/20 blur-3xl animate-pulse" />
